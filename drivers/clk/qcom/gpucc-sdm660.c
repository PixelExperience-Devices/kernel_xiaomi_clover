 ...
 *  ====================================================
 */
// Modified for higher clock, keep this as a bnon-selective change as normally
// when system pick speedbin 153 it has no 700+ freq, Original content below
...
static const struct freq_tbl ftbl_gfx3d_clk_src[] = {
	...
	F_GFX(750000000, 0,  2, 0, 0, 1294000000),
	{ }
};
